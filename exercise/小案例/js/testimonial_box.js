...
function toggleContent() {
  ...
  contentEl.innerText = testimonials[index].text
  imgEl.src = testimonials[index].photo
  nameEl.innerText = testimonials[index].name
  roleEl.innerText = testimonials[index].position
}
